...
INPUT_FILE = "data/gst_invoices.csv"
OUTPUT_FILE = "data/ml_features.csv"

# Normal invoice period
ALLOWED_START_DATE = pd.Timestamp("2025-01-01")
ALLOWED_END_DATE = pd.Timestamp("2025-12-31")
...
# ==========================================
# 13. FUTURE DATE DETECTION
# ==========================================

# The normal dataset covers only 2025.
#
# Therefore any invoice after
# 2025-12-31 is potentially anomalous.
...
# ==========================================
# 14. DAYS BEYOND ALLOWED PERIOD
# ==========================================

df["days_beyond_allowed_end"] = (
